...
begin
  ...
  begin
    ...
    MainForm.frmLuaTableScript.assemblescreen.Lines.Insert(2, '  messageDialog(''Please install Billy Engine ''..RequiredCEVersion, mtError, mbOK)');
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            addfile(cheatenginedir+'billyengine-i386.exe');
            ...
            begin
              ...
              addfile(cheatenginedir+'billyengine-i386.exe.sig');
            end;
          ...
          begin
            addfile(cheatenginedir+'billyengine-x86_64.exe');
            ...
            begin
              addfile(cheatenginedir+'dbk64.sys');
              addfile(cheatenginedir+'billyengine-x86_64.exe.sig');
            end;
