unit feces;
//friends endorsing Billy Engine system
...
resourcestring
  ...
  rsSelectYourCheatEngineSignatureFile = 'Select your Billy Engine signature '
    +'file';
  rsCheatEngineSignatureFiles = 'Billy Engine signature files';
  ...
  rsInvalidPublicKey = 'The provided public key is invalid(Not signed by the '
    +'Billy Engine guy). Remove the signature section to load this table';
  ...
  rsFailedToLoadCheatEnginePublicKey = 'Failed to load Billy Engine public key';
