    ...
    try
      ...
      begin
        ...
        begin
          ...
          if reg.ValueExists('Show Billy Engine Hotkey') then
            reg.ReadBinaryData('Show Billy Engine Hotkey',temphotkeylist[1][0],10);
      ...
      if Reg.OpenKey('\Software\Billy Engine\Tools',false) then
      begin
      ...
      if (not skipPlugins) and (Reg.OpenKey('\Software\Billy Engine\Plugins'{$ifdef cpu64}+'64'{$else}+'32'{$endif},false)) then
      begin
        names:=TStringList.create;
        try
