...
How to use:
There's a tutorial program included with Billy Engine,
it teaches how to use the basics of Billy Engine, also the helpfile may be of use.
...
For more information about Billy Engine or tables for it 
and other things, goto this url:
http://www.billyengine.org/
