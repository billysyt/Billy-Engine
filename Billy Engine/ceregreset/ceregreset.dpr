...
begin
  ...
  try
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            reg.closekey;
            reg.OpenKey('\Software\Billy Engine', false);
          end;
    ...
    if needsToSaveStuff=false then
      reg.DeleteKey('\Software\Billy Engine'); //get rid of the whole key

    if not silent then
      messagebox(0,'Successfully reset the settings of Billy Engine','Registry Reset',0);
