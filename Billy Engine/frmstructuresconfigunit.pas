...
begin
  ...
  try
    ...
    if Reg.OpenKey('\Software\Billy Engine\DissectData',true) then
    begin
      ...
      if customfont then
      begin
        if Reg.OpenKey('\Software\Billy Engine\DissectData\Font',true) then
...
begin
  ...
  try
    Reg.RootKey := HKEY_CURRENT_USER;
    if Reg.OpenKey('\Software\Billy Engine\DissectData',false) then
    begin
      ...
      if Reg.OpenKey('\Software\Billy Engine\DissectData\Font',false) then
      begin
