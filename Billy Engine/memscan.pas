...
resourcestring
  ...
  rsMSTheScanWasForcedToTerminateSubsequentScansMayNotFunctionProperlyEtc = 'The scan was forced to terminate. Subsequent scans may not function properly. It''s recommended to restart Billy Engine';
  rsThread = 'thread ';
//===============Local functions================//
...
begin
  ...
  fScanResultFolder:=usedtempdir+'Billy Engine'+pathdelim;
 ...
 // OutputDebugString('TMemscan.DeleteScanfolder');
  ...
  begin
    try
      ...
      if FindFirst(usedtempdir+'Billy Engine\{*}',  faDirectory , info)=0 then
      begin
        repeat
          ...
          begin
            ...
            begin
              ...
              f:=usedtempdir+'Billy Engine\'+info.name;
