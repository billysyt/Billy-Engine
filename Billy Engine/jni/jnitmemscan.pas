...
begin
  ...
  c:=penv^.FindClass(penv, 'org/billyengine/TObject');
...
var jnimethods: array [0..methodcount-1] of JNINativeMethod =(
  (name: 'create'; signature: '(Lorg/billyengine/TMemScan;)J'; fnPtr: @TMemScan_Create),
...
begin
  ...
  c:=env^.FindClass(env, 'org/billyengine/TMemScan');
