...
resourcestring
  ...
  rsThisWillAttachTheDebuggerOfCheatEngineToTheCurrent = 'This will attach the debugger of Billy Engine to the current process.';
  rsDoNotCloseCE = 'If you close Billy Engine while the game is running, the game will close too. Are you sure you want to do this?';
  rsContinue = 'Continue?';
