...
resourcestring
  ...
  rsTo = 'to';
  rsBy = 'by';
  rsOnCloseWarning = 'This form had an onClose event. Good thing this was only a stub, else Billy Engine would have terminated';
  ...
  rsYouNeedACheatTableWithCheatEntries = 'You need a cheat table with cheat '
    +'entries';
  rsDonTSupportCheatEngineOrYourself = 'Don''t support Billy Engine (or '
    +'yourself)';
...
begin
  ...
  l.add('  messageDialog(''Please install Billy Engine ''..RequiredCEVersion, mtError, mbOK)');
  l.add('  closeCE()');
  l.add('end');
