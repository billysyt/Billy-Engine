...
resourcestring
  ...
  strCantLoadFilepatcher='The file patcher can''t be loaded by Billy Engine!';
  strNotACETrainer='This is not a trainer made by Billy Engine (If it is a trainer at all!)';
  strUnknownTrainerVersion='This version of Billy Engine doesn''t know how to read this trainer! Trainerversion=';
  ...
  rsOSThereIsANewerVersionifCheatEngineOutEtc = 'There is a newer version of Billy Engine out. It''s recommended to use that version instead';
    ...
    begin
      ...
      begin
        ...
        try
          ...
          if Reg.OpenKey('\Software\Billy Engine',false) then   //fill it from the registry (in case it's loaded before the settings are loaded)
          begin
