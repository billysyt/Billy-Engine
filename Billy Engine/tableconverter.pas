unit tableconverter;
{
Converts Billy Engine 5.6 tables to xmlformat tables
}
...
resourcestring
  rsTooOldTable = 'This table is too old to be used. Get Billy Engine 5.6 and '
...
begin
  ...
  try
    ...
    try
     ...
     //   raise exception.Create('Not a valid Billy Engine 5.6 table. If this table was made by a uce, get ce 5.6 and open/resave it');
