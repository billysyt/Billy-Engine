...
begin
  synhighlighter.LoadFromRegistry(HKEY_CURRENT_USER, '\Software\Billy Engine\Lua Highlighter');
end;
...
begin
  ...
  begin
    synhighlighter.SaveToRegistry(HKEY_CURRENT_USER, '\Software\Billy Engine\Lua Highlighter');
