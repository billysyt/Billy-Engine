...
type
  TLuaSettings=class    //A wrapper for the registry object to make access to the Billy Engine settings easier and uniform
  private
    freg: Tregistry;
    fpath: string;
...
begin
  ...
  if freg.OpenKey('\Software\Billy Engine\'+v, true) then
    fpath:=v;
end;
...
begin
  ...
  freg.OpenKey('\Software\Billy Engine',true);
